...
export function ThinkingIndicator() {
  return (
    <div className="flex items-center gap-3 px-5 py-3 glass-panel rounded-2xl w-fit text-purple-200 animate-in fade-in slide-in-from-bottom-2 duration-300 shadow-[0_0_20px_rgba(147,51,234,0.15)] border-white/5">
